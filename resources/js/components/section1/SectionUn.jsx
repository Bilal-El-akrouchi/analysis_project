...
export default function SectionUn() {
    // const [retrecire, setRetrecire] = useState(false)
        ...
        <>
            ...
            <div className="flex h-screen w-full items-center justify-center mt-10">
                <div className="relative flex w-[80%] items-center justify-end">
                    <div className="glassed absolute left-25 z-5 min-h-[65vh] w-2/3 p-5">
                    
                        <h1 className="">TITRE ARTICLE 1</h1>
                    ...
                    <div className="bg-blanc absolute bottom-[-220px] left-[30] z-0 min-h-[63vh] w-[40%] rounded"></div>
